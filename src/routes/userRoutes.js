...
const { getAllUsers, updatePorfileById, getSingleUser, getNewFriendRequests, getAllFollowingFriends, getProfileStatics } = require("../controllers/UserController");
...
userRoute.get('/profile/statics', isLogin, getProfileStatics)
